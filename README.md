...
> 请将截图保存到 `docs/images/` 目录后，GitHub 会自动显示下面的图片。

| 主界面 | 本地音乐文件夹 |
| --- | --- |
| ![播放器主界面](docs/images/player-main.png) | ![本地音乐文件夹](docs/images/music-folder.png) |

| 项目目录结构 |
| --- |
| ![项目目录结构](docs/images/project-structure.png) |
...
播放器窗口获得焦点时支持以下快捷键；程序运行期间也会尝试注册对应的全局快捷键。
